...
import { ThemeType, useThemeMode } from '../utils/useThemeMode';
                ...
                <div className="w-full lg:w-1/2 px-6 flex flex-col justify-between">
                  ...
                  <div className="relative w-36">
                    ...
                    <select
                      ...
                      className="w-full focus:outline-none pl-10 py-1.5 appearance-none flex items-center border rounded border-gray-700 text-black dark:border-gray-50 text-sm leading-5 dark:bg-gray-900 dark:text-gray-50"
                    >
