...
const modelsInfo = {
    ...
    Movie: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    Serie: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    Season: ["id", "title", "index", "episodes", "seriesId", "launchDate", "createdAt", "updatedAt"],
    Episode: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId"]
};
...
const outputsInfo = {
    ...
    MovieGroupBy: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateSerie: ["_count", "_avg", "_sum", "_min", "_max"],
    SerieGroupBy: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    EpisodeGroupBy: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    MovieCountAggregate: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "_all"],
    MovieAvgAggregate: ["id", "year", "runtime", "imdbRating"],
    MovieSumAggregate: ["id", "year", "runtime", "imdbRating"],
    MovieMinAggregate: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    MovieMaxAggregate: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    SerieCount: ["genres", "directors", "actors", "languages", "seasons"],
    SerieCountAggregate: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "_all"],
    SerieAvgAggregate: ["id", "year", "runtime", "imdbRating", "totalSeasons"],
    SerieSumAggregate: ["id", "year", "runtime", "imdbRating", "totalSeasons"],
    SerieMinAggregate: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    SerieMaxAggregate: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    ...
    EpisodeCountAggregate: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId", "_all"],
    EpisodeAvgAggregate: ["id", "runtime", "imdbRating", "seasonId"],
    EpisodeSumAggregate: ["id", "runtime", "imdbRating", "seasonId"],
    EpisodeMinAggregate: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId"],
    EpisodeMaxAggregate: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId"]
};
...
const inputsInfo = {
    ...
    MovieWhereInput: ["AND", "OR", "NOT", "id", "title", "year", "rating", "release", "runtime", "genres", "directors", "actors", "plot", "languages", "poster", "imdbRating", "createdAt", "updatedAt"],
    MovieOrderByWithRelationAndSearchRelevanceInput: ["id", "title", "year", "rating", "release", "runtime", "genres", "directors", "actors", "plot", "languages", "poster", "imdbRating", "createdAt", "updatedAt", "_relevance"],
    MovieWhereUniqueInput: ["id", "title"],
    MovieOrderByWithAggregationInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
    MovieScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    SerieWhereInput: ["AND", "OR", "NOT", "id", "title", "year", "rating", "release", "runtime", "genres", "directors", "actors", "plot", "languages", "poster", "imdbRating", "totalSeasons", "seasons", "createdAt", "updatedAt"],
    SerieOrderByWithRelationAndSearchRelevanceInput: ["id", "title", "year", "rating", "release", "runtime", "genres", "directors", "actors", "plot", "languages", "poster", "imdbRating", "totalSeasons", "seasons", "createdAt", "updatedAt", "_relevance"],
    SerieWhereUniqueInput: ["id", "title"],
    SerieOrderByWithAggregationInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
    SerieScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    ...
    EpisodeWhereInput: ["AND", "OR", "NOT", "id", "title", "runtime", "plot", "poster", "imdbRating", "season", "seasonId"],
    EpisodeOrderByWithRelationAndSearchRelevanceInput: ["id", "title", "runtime", "plot", "poster", "imdbRating", "season", "seasonId", "_relevance"],
    EpisodeWhereUniqueInput: ["id"],
    EpisodeOrderByWithAggregationInput: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId", "_count", "_avg", "_max", "_min", "_sum"],
    EpisodeScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId"],
    ...
    LanguageCreateInput: ["name", "createdAt", "updatedAt", "movies", "series"],
    LanguageUpdateInput: ["name", "createdAt", "updatedAt", "movies", "series"],
    LanguageCreateManyInput: ["id", "name", "createdAt", "updatedAt", "seriesId"],
    LanguageUpdateManyMutationInput: ["name", "createdAt", "updatedAt"],
    MovieCreateInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "genres", "directors", "actors", "languages"],
    MovieUpdateInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "genres", "directors", "actors", "languages"],
    MovieCreateManyInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    MovieUpdateManyMutationInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    SerieCreateInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "directors", "actors", "languages", "seasons"],
    SerieUpdateInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "directors", "actors", "languages", "seasons"],
    SerieCreateManyInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    SerieUpdateManyMutationInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    ...
    EpisodeCreateInput: ["title", "runtime", "plot", "poster", "imdbRating", "season"],
    EpisodeUpdateInput: ["title", "runtime", "plot", "poster", "imdbRating", "season"],
    EpisodeCreateManyInput: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId"],
    EpisodeUpdateManyMutationInput: ["title", "runtime", "plot", "poster", "imdbRating"],
    ...
    MovieCountOrderByAggregateInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    MovieAvgOrderByAggregateInput: ["id", "year", "runtime", "imdbRating"],
    MovieMaxOrderByAggregateInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    MovieMinOrderByAggregateInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    ...
    SerieCountOrderByAggregateInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    SerieAvgOrderByAggregateInput: ["id", "year", "runtime", "imdbRating", "totalSeasons"],
    SerieMaxOrderByAggregateInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    SerieMinOrderByAggregateInput: ["id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    ...
    EpisodeCountOrderByAggregateInput: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId"],
    EpisodeAvgOrderByAggregateInput: ["id", "runtime", "imdbRating", "seasonId"],
    EpisodeMaxOrderByAggregateInput: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId"],
    EpisodeMinOrderByAggregateInput: ["id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId"],
    ...
    SerieCreateNestedOneWithoutLanguagesInput: ["create", "connectOrCreate", "connect"],
    ...
    SerieUpdateOneWithoutLanguagesInput: ["create", "connectOrCreate", "upsert", "connect", "disconnect", "delete", "update"],
    ...
    LanguageCreateNestedManyWithoutSeriesInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    LanguageUpdateManyWithoutSeriesInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    ...
    MovieCreateWithoutGenresInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "directors", "actors", "languages"],
    MovieCreateOrConnectWithoutGenresInput: ["where", "create"],
    SerieCreateWithoutGenresInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "directors", "actors", "languages", "seasons"],
    ...
    MovieScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt"],
    ...
    SerieScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt"],
    MovieCreateWithoutDirectorsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "genres", "actors", "languages"],
    MovieCreateOrConnectWithoutDirectorsInput: ["where", "create"],
    SerieCreateWithoutDirectorsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "actors", "languages", "seasons"],
    ...
    SerieUpdateWithoutDirectorsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "actors", "languages", "seasons"],
    MovieCreateWithoutActorsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "genres", "directors", "languages"],
    MovieCreateOrConnectWithoutActorsInput: ["where", "create"],
    SerieCreateWithoutActorsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "directors", "languages", "seasons"],
    ...
    SerieUpdateWithoutActorsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "directors", "languages", "seasons"],
    MovieCreateWithoutLanguagesInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "genres", "directors", "actors"],
    MovieCreateOrConnectWithoutLanguagesInput: ["where", "create"],
    SerieCreateWithoutLanguagesInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "directors", "actors", "seasons"],
    ...
    SerieUpsertWithoutLanguagesInput: ["update", "create"],
    SerieUpdateWithoutLanguagesInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "directors", "actors", "seasons"],
    ...
    LanguageCreateWithoutMoviesInput: ["name", "createdAt", "updatedAt", "series"],
    ...
    LanguageCreateWithoutSeriesInput: ["name", "createdAt", "updatedAt", "movies"],
    LanguageCreateOrConnectWithoutSeriesInput: ["where", "create"],
    LanguageCreateManySeriesInputEnvelope: ["data", "skipDuplicates"],
    ...
    EpisodeCreateWithoutSeasonInput: ["title", "runtime", "plot", "poster", "imdbRating"],
    EpisodeCreateOrConnectWithoutSeasonInput: ["where", "create"],
    EpisodeCreateManySeasonInputEnvelope: ["data", "skipDuplicates"],
    SerieCreateWithoutSeasonsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "directors", "actors", "languages"],
    ...
    EpisodeScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "runtime", "plot", "poster", "imdbRating", "seasonId"],
    SerieUpsertWithoutSeasonsInput: ["update", "create"],
    SerieUpdateWithoutSeasonsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "genres", "directors", "actors", "languages"],
    ...
    MovieUpdateWithoutGenresInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "directors", "actors", "languages"],
    SerieUpdateWithoutGenresInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "totalSeasons", "createdAt", "updatedAt", "directors", "actors", "languages", "seasons"],
    MovieUpdateWithoutDirectorsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "genres", "actors", "languages"],
    MovieUpdateWithoutActorsInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "genres", "directors", "languages"],
    MovieUpdateWithoutLanguagesInput: ["title", "year", "rating", "release", "runtime", "plot", "poster", "imdbRating", "createdAt", "updatedAt", "genres", "directors", "actors"],
    ...
    LanguageUpdateWithoutMoviesInput: ["name", "createdAt", "updatedAt", "series"],
    DirectorCreateManySeriesInput: ["id", "name", "createdAt", "updatedAt"],
    ActorCreateManySeriesInput: ["id", "name", "createdAt", "updatedAt"],
    LanguageCreateManySeriesInput: ["id", "name", "createdAt", "updatedAt"],
    ...
    LanguageUpdateWithoutSeriesInput: ["name", "createdAt", "updatedAt", "movies"],
    SeasonUpdateWithoutSeriesInput: ["title", "index", "episodes", "launchDate", "createdAt", "updatedAt", "episodeIds"],
    EpisodeCreateManySeasonInput: ["id", "title", "runtime", "plot", "poster", "imdbRating"],
    EpisodeUpdateWithoutSeasonInput: ["title", "runtime", "plot", "poster", "imdbRating"]
};
