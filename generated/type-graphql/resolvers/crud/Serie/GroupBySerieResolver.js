...
exports.GroupBySerieResolver = void 0;
...
let GroupBySerieResolver = class GroupBySerieResolver {
...
], GroupBySerieResolver.prototype, "groupBySerie", null);
GroupBySerieResolver = __decorate([
    TypeGraphQL.Resolver(_of => Serie_1.Serie)
], GroupBySerieResolver);
exports.GroupBySerieResolver = GroupBySerieResolver;
